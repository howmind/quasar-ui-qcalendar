  ...
  methods: {
    ...
    __adjustForWeekEvents() {
      ...
      for (; i < 7; ++i) {
        ...
        const margin =
          parseFloat(styles.marginTop, 10) +
    ...
    __renderHeadDays(h) {
      return h(
        ...
        [
          ...this.todayWeek.map((day, index) =>
            this.__renderHeadDay(h, day, index)
          ),
        ]
      );
    },
    ...
    __renderHeadDay(h, day, index) {
      ...
      const disabled = this.disabledWeekdays
      ...
      return h(
        ...
        [
          headDaySlot === undefined &&
            this.__renderHeadDayLabel(
              h,
              day,
              this.shortWeekdayLabel || this.isMiniMode
            ),
    ...
    __renderWeeks(h) {
      ...
      for (let i = 0; i < days.length; i += weekDays) {
        weeks.push(
          this.__renderWeek(h, days.slice(i, i + weekDays), i / weekDays)
        );
      }
    ...
    __renderWeek(h, week, weekNum) {
      ...
      style.height =
        this.dayHeight > 0 ? convertToUnit(this.dayHeight) : "auto";
    ...
    __renderDay(h, day) {
      ...
      const dayClass =
        typeof this.dayClass === "function" ? this.dayClass(day) : null;
      ...
      return h(
        ...
        [
          ...
          this.isMiniMode !== true && this.showDayOfYearLabel && !hasMonth
            ...
            : "",
          this.isMiniMode !== true && hasMonth
            ? this.__renderDayMonth(h, day)
            : "",
        ]
      );
    },
        ...
        : h(
            QBtn,
            {
              ...
              props: {
                ...
                disable:
                  day.disabled === true ||
                  (this.enableOutsideDays !== true && outside === true),
              },
              style: {
